...
<%-- 
	...
	● [Java Bean 객체생성]
		<jsp:useBean 	id="객체명" 
						class="패키지명.클래스명" 
						scope="page"> 해당페이지에서만 id를 쓸수있음
		</jsp:useBean>
		
	● [Scope 유효범위]
		- scope="page"			현재 페이지에서만 유효. 생략시 기본값
		- scope="request"		다른 페이지에서 공유 가능
		- scope="session"		다른 페이지에서 공유 가능
		- scope="application"	다른 페이지에서 공유 가능
...
<body>
	<h3>＊ 계산 결과 ＊</h3>
	<h4>3)Java Bean을 이용해서 객체생성 후 메소드 호출</h4>
<%
