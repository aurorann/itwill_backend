...
-- primary key 제약조건
-- ORA-00001: 무결성 제약 조건(SYSTEM.SYS_C007329)에 위배됩니다
-- sno 칼럼은 기본(PK)이므로 종복된 값을 허용하지 않음
insert into sungjuk(sno, uname) values(1, '홍길동'); --두번 실행했을 때 에러 발생
...
-- check 제약조건
-- ORA-02290: 체크 제약조건(SYSTEM.SYS_C007338)이 위배되었습니다
insert into sungjuk(sno, uname, kor, eng, mat)
values(1, '홍길동', -10, 20, 300);

-- ORA-02290: 체크 제약조건(SYSTEM.SYS_C007339)이 위배되었습니다
