...
<tr>
	...
	<td style="text-align: left">
		<input type="text" name="id" id="id" value="<%=dto.getId() %>" size="10" maxlength="10" readonly>&nbsp;&nbsp;
	</td>
</tr> 
<tr>
	<th>⁕ 비밀번호</th>
...
<tr>
	<th>⁕ 이름</th>
	<td style="text-align: left">
		<input type="text" name="mname" id="mname" value="<%=dto.getMname() %>" size="20" maxlength="20" required>
	</td>
</tr> 
<tr>
	<th>⁕ 이메일</th>
...
<tr>
	<th>주소</th>
	<td style="text-align: left">
		<input type="text" name="address1" id="address1"  value="<%=dto.getAddress1() %>"size="45" readonly>
	</td>
</tr> 
<tr>
	<th>나머지주소</th>
	<td style="text-align: left">
		<input type="text" name="address2" id="address2"  value="<%=dto.getAddress2() %>"size="45">
	</td>
</tr> 
<tr>  
  <th>직업</th>
