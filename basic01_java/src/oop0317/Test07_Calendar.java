...
public class Test07_Calendar {
	...
	public static void main(String[] args) {
		...
		System.out.println(now.get(Calendar.HOUR));		//시		5
		System.out.println(now.get(Calendar.MINUTE));	//분		14
		System.out.println(now.get(Calendar.SECOND));	//초		12
		...
		System.out.println(myBirth.get(Calendar.MONTH)+1);
