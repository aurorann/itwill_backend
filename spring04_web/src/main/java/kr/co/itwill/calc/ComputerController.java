...
public class ComputerController {
	...
	public ComputerController() {
		System.out.println("----------ComputerController()객체 생성");
	}//end
	...
	public ModelAndView diff(@RequestParam("no1") int a, @RequestParam("no2") int b) {
		...
		mav.addObject("img", "<img src='images/bearggu4.gif'>");
	...
	public ModelAndView max(int no1, int no2) {
		...
		mav.addObject("result", result);
		mav.addObject("message", "<h3>두수 중에 큰 값</h3>");
		mav.addObject("img", "<img src='images/bearggu4.gif'>");
